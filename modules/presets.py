...
CHUANHU_TITLE = i18n("小亮Chat 👀")

# CHUANHU_DESCRIPTION = i18n("由Bilibili [土小亮虎虎](https://space.bilibili.com/29125536) 和 [明昭MZhao](https://space.bilibili.com/24807452)开发<br />访问小亮Chat的 [GitHub项目](https://github.com/GaiZhenbiao/ChuanhuChatGPT) 下载最新版脚本")
